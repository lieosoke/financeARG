...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: Vendor debts creation and payment recording did not complete as expected. The expected confirmation message "Vendor Debt Successfully Created" was not found on the page.')
