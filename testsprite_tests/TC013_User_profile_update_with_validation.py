...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution failed to verify profile update functionality including frontend and backend validation preventing invalid input.")
