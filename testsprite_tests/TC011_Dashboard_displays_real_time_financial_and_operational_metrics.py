...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: Dashboard did not load correctly with up-to-date financial metrics, cash flow charts, and key statistics following data changes.')
