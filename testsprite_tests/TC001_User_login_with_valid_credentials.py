...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: User was not authenticated and redirected to the dashboard as expected after login attempt with valid credentials.')
