...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expense recording did not complete successfully. The expense was not recorded, categorized correctly, or did not appear in the expense and cash flow reports as required by the test plan.")
