...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The travel package creation did not succeed as expected. The package was not saved or did not appear in the package list after submission.')
